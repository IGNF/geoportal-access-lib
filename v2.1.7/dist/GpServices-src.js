...
})(window, function(__WEBPACK_EXTERNAL_MODULE__15__, __WEBPACK_EXTERNAL_MODULE__16__) {
...
/* harmony import */ var _Services_ProcessIsoCurve_Response_model_ProcessIsoCurveResponse__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(101);
/* harmony import */ var _Services_Route_Response_model_RouteResponse__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(93);
/* harmony import */ var _Services_Route_Response_model_RouteInstruction__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(94);
...
/* harmony import */ var _ProcessIsoCurve_ProcessIsoCurve__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(96);
  ...
  __call: function __call(options) {
    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      if (typeof window === "undefined") {
        ...
        var req = __webpack_require__(15); // __request
...
/* harmony import */ var _Response_RouteResponseFactory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(90);
...
function Route(options) {
  ...
  this.options.api = typeof options.api === "string" ? options.api.toUpperCase() : "REST"; // on passe l'option outputFormat en minuscules afin d'éviter des exceptions.
  ...
  this.options.srs = options.srs || "EPSG:4326"; // FIXME : les readers OLS ne sont pas implémentés. on utilise donc l'API REST.
...
Route.prototype.analyzeResponse = function (error, success) {
  ...
  if (this.response) {
    var options = {
      distanceUnit: this.options.distanceUnit,
      // FIXME ce parametre nous permet de choisir le type d'unité dans la reponse !
      response: this.response,
      outputFormat: this.options.outputFormat,
      // utile pour parser la string en mode XHR : JSON ou XML !
      api: this.options.api,
      // utile de connaitre le type d'API car la reponse est differente !
      rawResponse: this.options.rawResponse,
      onError: error,
      onSuccess: success,
      scope: this
...
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _Exceptions_ErrorService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _RouteRequestOLS__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(83);
/* harmony import */ var _RouteRequestREST__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(88);
/**
...
var RouteRequestFactory = {
  ...
  build: function build(options) {
    ...
    var bOnError = !!(options.onError !== null && typeof options.onError === "function");
    var message = null; // choix entre les 2 types d'API pour consulter le service
...
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _Formats_XLS__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51);
/* harmony import */ var _Formats_XLS_RouteService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84);
/**
 * Creation d'une requête OpenLS en mode POST ou GET
 * (Factory)
 *
...
var RouteRequestOLS = {
  ...
  build: function build(options) {
    ...
    var request = null; // spécifique au service

    var settings = {
      startPoint: options.startPoint,
      endPoint: options.endPoint,
      viaPoint: options.viaPoints,
      // mapping OLS et options
    ...
    var oRS = new _Formats_XLS_RouteService__WEBPACK_IMPORTED_MODULE_2__["default"](settings); // Format XLS
    ...
    oXLS.namespace = true;
    oXLS.setService(oRS); // request brute !
...
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _AbstractService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54);
/* harmony import */ var _RouteService_DetermineRouteRequest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(85);
/* harmony import */ var _RouteService_RouteRequestExtension__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(87);
...
function RouteService(options) {
  ...
  this.CLASSTYPE = "RouteRequest"; // appel du constructeur par heritage
...
RouteService.prototype = Object.create(_AbstractService__WEBPACK_IMPORTED_MODULE_1__["default"].prototype, {// todo
  // getter/setter
});
/**
 * Constructeur (alias)
...
RouteService.prototype.toString = function () {
  ...
  if (!this.oRequest) {
    ...
    if (this.CLASSTYPE === "RouteRequest") {
      ...
      this.oRequest = new _RouteService_DetermineRouteRequest__WEBPACK_IMPORTED_MODULE_2__["default"](settings); // ajout des filtres spécifiques au service
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _model_RoutePlan__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86);
...
DetermineRouteRequest.prototype = {
   ...
   */
  addRoute: function addRoute(oRoutePlan) {
  ...
  toString: function toString() {
    ...
    template = template.replace(/__DISTANCEUNIT__/g, this.options.distanceUnit || "KM"); // soit on a déjà un objet RoutePlan instancié,
    // sinon, on le fabrique via les options
    ...
    template = template.replace(/__ROUTEPLAN__/g, this.oRoutePlan.toString()); // instruction
    ...
    template = template.replace(/__ROUTEINSTRUCTIONREQUEST__/g, tmplInstruction); // geometry

    var tmplGeometry = this.template.routeGeometryRequest;
    template = template.replace(/__ROUTEGEOMETRYREQUEST__/g, tmplGeometry); // map
...
RoutePlan.prototype = {
  ...
  template: {
    ...
    wayPointList: {
      ...
      viaPoint: "<ViaPoint>" + "__POINT__" + "</ViaPoint>" // implémentation de plusieurs étapes...
  ...
  toString: function toString() {
    var template = "";
    template = this.template.routePlan; // preference
    ...
    template = template.replace(/__ROUTEPREFERENCE__/g, ""); // exclusions
    ...
    template = template.replace(/__AVOIDLIST__/g, ""); // graph
    ...
    template = template.replace(/__GRAPH__/g, ""); // points
    ...
    tmplWayPointList = tmplWayPointList.replace(/__STARTPOINT__/, this.template.wayPointList.startPoint.replace(/__POINT__/, tmplPoint)); // end

    tmplPoint = this.template.wayPointList.point;
    tmplPoint = tmplPoint.replace(/__X__/, this.options.endPoint.x);
    tmplPoint = tmplPoint.replace(/__Y__/, this.options.endPoint.y);
    tmplWayPointList = tmplWayPointList.replace(/__ENDPOINT__/, this.template.wayPointList.endPoint.replace(/__POINT__/, tmplPoint)); // via
...
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _Utils_MessagesResources__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _model_RouteParamREST__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(89);
...
function RouteParamREST(options) {
  ...
  this.method = "TIME"; // mapping particulier sur l'option 'routePreference'
  ...
  this.format = this.options.geometryInInstructions ? "STANDARDEXT" : "STANDARD"; // y'a t-il d'autres options à ajouter (par defaut) ?
  ...
  this.profileName = null; // options dont le mapping n'est pas possible :
  // - distanceUnit
  // - provideBoundingBox
}
/**
...
/* harmony import */ var _Exceptions_ErrorService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _Formats_XML__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28);
/* harmony import */ var _Formats_WKT__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91);
/* harmony import */ var _Formats_RouteResponseRESTReader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(92);
/* harmony import */ var _Formats_RouteResponseOLSReader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(95);
/* harmony import */ var _model_RouteResponse__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(93);
/* harmony import */ var _model_RouteInstruction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(94);
/**
 * Factory pour générer une reponse JSON à partir d'un XML ou d'un JSON
 * (Factory)
 *
  ...
  build: function build(options) {
    ...
    if (options.response) {
      if (options.rawResponse) {
        ...
        switch (options.outputFormat) {
          case "xml":
            logger.trace("analyze response : xml"); // type de reader en fonction de l'API
          ...
          case "json":
            ...
            if (JSONResponse) {
              ...
              */
              ...
              var onWKTError = function onWKTError(e) {
                console.log(e);
              ...
              if (data.hasOwnProperty("routeInstructions")) {
                ...
                steps.forEach(function (step) {
                  ...
                  data.routeInstructions[data.routeInstructions.length - 1].code = step.navInstruction; // geometrie en geojson
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Utils_MessagesResources__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _Formats_WKT__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(91);
/* harmony import */ var _Exceptions_ErrorService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _Response_model_RouteResponse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93);
/* harmony import */ var _Response_model_RouteInstruction__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(94);
/**
...
RouteResponseRESTReader.READERS = {
   ...
   */
  routeResult: function routeResult(node) {
    var response = new _Response_model_RouteResponse__WEBPACK_IMPORTED_MODULE_3__["default"](); // on boucle sur les balises "enfant" de la réponse :
   ...
   * @param {Object} response - response
   */
  durationSeconds: function durationSeconds(node, response) {
    if (response) {
   ...
   * @param {Object} response - response
   */
  bounds: function bounds(node, response) {
   ...
   * @param {Object} response - response
   */
  geometryWkt: function geometryWkt(node, response) {
    if (response) {
   ...
   * @param {Object} response - response
   */
  step: function step(node, response) {
    ...
    var name; // lecture des informations de l'instruction (balises enfants)
...
/* harmony import */ var _CommonService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _DefaultUrlService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
/* harmony import */ var _Request_ProcessIsoCurveRequest__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(97);
/* harmony import */ var _Response_ProcessIsoCurveResponseFactory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(99);
...
/* harmony import */ var _Utils_LoggerByDefault__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _Utils_MessagesResources__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _model_ProcessIsoCurveParam__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(98);
...
/* harmony import */ var _Formats_XML__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28);
/* harmony import */ var _Formats_WKT__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91);
/* harmony import */ var _Formats_ProcessIsoCurveResponseReader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(100);
/* harmony import */ var _model_ProcessIsoCurveResponse__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(101);
/**
 * Factory pour générer une reponse JSON à partir d'un XML ou d'un JSON
 * (Factory)
 *
...
/* harmony import */ var _Formats_WKT__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(91);
/* harmony import */ var _Exceptions_ErrorService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _Response_model_ProcessIsoCurveResponse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(101);
/**
