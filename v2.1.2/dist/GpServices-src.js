 ...
 *
 * @param {Boolean} [options.ssl] - Indique si l'on souhaite interroger les services en https.
 *      Par défaut, on utilise le protocole https (ssl=true).
 *
...
var Services = {
     ...
     * @param {Boolean} [options.ssl = true] - Use of HTTP or HTTPS protocol to request the services. HTTPS by default (ssl=true).
