...
if (mock) {
    ...
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponse = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-StreetAddress.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponseSA = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-POI.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponsePOI = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-Parcel.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponseParcel = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-SA-POI.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponseSA_POI = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-structured-location.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponseStructuredLocation = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-response-freeform.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeResponseFreeform = data;
    });
    fetch('test/end-to-end/spec-functional/fixtures/geocode-request.xml')
    .then(response => response.text())
    .then((data) => {
        logger.warn(data);
        geocodeRequest = data;
...
describe("-- Tests fonctionnels du Service de Geocodage direct --", function () {
