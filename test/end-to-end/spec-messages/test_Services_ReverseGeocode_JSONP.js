...
describe("-- Test sur les messages d'erreur spécifiques du Service Geocodage Inverse : JSONP --", function() {
    ...
    it("Erreur de clef API : clef inconnue du service", function (done) {
        ...
        // Type : SERVICE_ERROR
        // Status : 403
        if (mock) { options_reverse.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-bad-key'; }
    ...
    it("INVERSE Erreur de countryCode: ce code n'existe pas", function (done) {
        ...
        if (mock) { options_reverse.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-bad-rights'; }
