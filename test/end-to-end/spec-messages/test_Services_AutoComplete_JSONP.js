...
describe("-- Test sur les messages d'erreur spécifiques du Service d'AutoCompletion : JSONP --", function() {
    ...
    it("JSONP Erreur de countryCode : ce code n'existe pas", function (done) {
        ...
        // this.timeout(1000);
        if (mock) { options.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-bad-rights'; }
