...
describe("-- Test sur les messages d'erreur spécifiques du Service Alti : JSONP --", function() {
    ...
    it("JSONP Erreur de positions : coordonnées 'lon' manquantes", function (done) {
        ...
        if (mock) { options.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-alti-bad-param-lon'; }
    ...
    it("JSONP Erreur de positions : coordonnées 'lat' manquantes", function (done) {
        ...
        if (mock) { options.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-alti-bad-param-lat'; }
    ...
    it("JSONP Erreur de positions : coordonnées avec une decimal non supportée", function (done) {
        ...
        if (mock) { options.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-alti-bad-param-format'; }
