...
describe("-- Test sur les messages d'erreur communs à tous les services : JSONP --", function() {
    ...
    xit("ALTI - timeout = 0 sur un service qui repond !", function (done) {
        ...
        setTimeout(done, 1000);
        options.timeOut = 0;
        if (mock) { options.serverUrl = 'test/end-to-end/spec-messages/fixtures/jsonp/callback-alti-ok'; }
        options.onFailure = function (e) {
            done(e);
        };
        options.onSuccess = function (response) {
