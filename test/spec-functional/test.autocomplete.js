        ...
        describe('Service.autoComplete : SUCCESS', function () {
            ...
            describe("Tests sur les options du protocole du service", function () {
                ...
                it("Appel du service en mode 'XHR' avec la méthode 'GET'", function (done) {
                    ...
                    var urlTypeGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=PositionOfInterest&terr=METROPOLE&maximumResponses=1";
            ...
            describe("Test sur les options spécifiques du service", function () {
                ...
                describe("L'option 'text' seulement est renseignée", function() {
                    ...
                    it("text est renseigné, autres paramètres : valeur par défaut", function (done) {
                        ...
                        var urlTypeGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=StreetAddress&terr=&maximumResponses=10";
                ...
                describe("Les options 'text' et 'maximumResponses' sont renseignées", function() {
                    ...
                    it("maximumResponses = 1", function (done) {
                        ...
                        var urlTypeGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=StreetAddress&terr=&maximumResponses=1";
                    ...
                    it("maximumResponses = 2", function (done) {
                        ...
                        var urlTypeGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=StreetAddress&terr=&maximumResponses=2";
                        var okResponseTypeJson = [200, { 'Content-type': 'application/json' }, '{"status":"OK","results":[{"country":"StreetAddress","x":1.538295,"y":43.19646,"city":"Brie","zipcode":"09700","street":"courreste","kind":"","fulltext":"courreste, 09700 Brie","classification":7},{"country":"StreetAddress","x":1.509347,"y":43.222904,"city":"Brie","zipcode":"09700","street":"la coutensou","kind":"","fulltext":"la coutensou, 09700 Brie","classification":7}]}'];
                        if (mock) { server.respondWith('GET', urlTypeGet, okResponseTypeJson); }
                    ...
                    it("maximumResponses = 5", function (done) {
                        ...
                        var urlTypeGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Saint-M&type=StreetAddress&terr=&maximumResponses=5";
                    ...
                    it("maximumResponses est null", function (done) {
                        ...
                        var urlDefautGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Saint-M&type=StreetAddress&terr=&maximumResponses=10";
                ...
                describe("Les options 'text' et 'filterOptions' sont renseignées (et maximumResponses=1)", function() {
                    ...
                    it("type = PostionOfInterest", function(done) {
                        ...
                        var urlType1Get = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=PositionOfInterest&terr=&maximumResponses=1";
                    ...
                    it("type = StreetAddress", function(done) {
                        ...
                        var urlType1Get = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=StreetAddress&terr=&maximumResponses=1";
                    ...
                    it("type = PostionOfInterest,StreetAddress (maximumResponses=10)", function(done) {
                        ...
                        var urlType2Get = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=PositionOfInterest,StreetAddress&terr=&maximumResponses=10";
                    ...
                    it("territory = METROPOLE", function(done) {
                        ...
                        var urlTerritoryGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Brie-Co&type=StreetAddress&terr=METROPOLE&maximumResponses=1";
                    ...
                    it("territory = DOMTOM", function(done) {
                        ...
                        var urlTerritoryGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Saint-B&type=StreetAddress&terr=DOMTOM&maximumResponses=1";
                    ...
                    it("territory avec code INSEE de commune", function(done) {
                        ...
                        var urlTerritoryGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=rue&type=StreetAddress&terr=94067&maximumResponses=1";
                    ...
                    it("territory avec code INSEE de département", function(done) {
                        ...
                        var urlTerritoryGet = "http://wxs.ign.fr/" + myKey + "/ols/apis/completion?text=Saint-M&type=StreetAddress&terr=94&maximumResponses=1";
