...
define(['chai'], function (chai) {
    ...
    describe("-- Test ProcessIsoCurveRequest --", function() {
        ...
        var ProcessIsoCurveRequest;
        var XML;

        beforeEach(function(done) {
            require(['Formats/XML', 'Services/ProcessIsoCurve/Request/ProcessIsoCurveRequest'], function(_XML, _ProcessIsoCurveRequest) {
                XML = _XML;
                ProcessIsoCurveRequest = _ProcessIsoCurveRequest;
                done();
            });
        });
