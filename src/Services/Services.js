...
define([
    ...
    function (
        ...
        var Services = {
            ...
            * @param {String} [options.protocol=JSONP] - Protocol used to handle dialog with web service. Possible values are 'JSONP' ({@link https://en.wikipedia.org/wiki/JSONP}) and 'XHR' ({@link https://en.wikipedia.org/wiki/XMLHttpRequest}). Using the XHR protocol in an environment NodeJS. Only use if you know what you're doing.
            ...
            * @param {String} [options.protocol=XHR] - Protocol used to handle dialog with web service. Possible values are 'JSONP' ({@link https://en.wikipedia.org/wiki/JSONP}) and 'XHR' ({@link https://en.wikipedia.org/wiki/XMLHttpRequest}). Using the XHR protocol in an environment NodeJS. Only use if you know what you're doing.
