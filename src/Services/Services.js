...
define([
    ...
    function (
        ...
        var Services = {
            ...
            * @param {String} [options.contentType=null] - content-Type to use when requesting underlying web service in case of a XHR protocol use (see above) and if method HTTP is POST. Ignored when options.protocol is set to default 'JSONP' value. Only use if you know what you are doing.
