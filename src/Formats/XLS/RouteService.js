 define([
    ...
    "Formats/XLS/AbstractService",
    "Formats/XLS/RouteService/DetermineRouteRequest",
    "Formats/XLS/RouteService/RouteRequestExtension"
],
function (Logger, AbstractService, DetermineRouteRequest, RouteRequestExtension) {
