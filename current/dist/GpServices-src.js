...
XLS.prototype = {
     ...
     * 2.1.4, __NAMESPACE__, __SCHEMALOCATION__
...
XLS.prototype.build = function () {
    ...
    template = template.replace(/2.1.4/g, XLS.VERSION);
...
WPS.prototype = {
    ...
    template : {
        ...
        post : {
            ...
            value : "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                "<wps:__REQUEST__ version=\"2.1.4\" service=\"__SERVICE__\" " +
    ...
    processRequestString : function () {
        ...
        template = template.replace(/2.1.4/g, this.paramversion);
...
Request.prototype = {
     ...
     * Template de la requête.
     * substitution des valeurs suivantes :
     * __MAXRESPONSES__, __METHODNAME__, __UUID__, 2.1.4
     * __REQUESTSERVICE__
     */
    template : "<Request maximumResponses=\"__MAXRESPONSES__\" methodName=\"__METHODNAME__\" requestID=\"__UUID__\" version=\"2.1.4\">" +
        "<!-- __REQUESTSERVICE__ -->" +
        "</Request>",
    ...
    toString : function () {
        ...
        template = template.replace(/2.1.4/g, this.options.version);
